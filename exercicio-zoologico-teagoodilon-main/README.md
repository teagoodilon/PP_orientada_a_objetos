[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=8134317&assignment_repo_type=AssignmentRepo)
...
Atributos: String nome, String especie, int qtdPatas, String som;

Métodos: getNome(), getEspecie(), getQtdPatas(), getSom(), getDescricao(), getDescLonga();

**Classe Peludo**

Atributos: String corPelo;

Métodos: getCor(), getDescLonga();

**Classe Voador**

Atributos: boolean voaBem;

Métodos: getVoaBem(), getDescLonga();
